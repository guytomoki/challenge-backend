...
CREATE TABLE users_signing_requests (
	signing_requests_id int8 NOT NULL,
	user_id int8 NOT NULL,
	CONSTRAINT users_signing_requests_signing_requests_id_key UNIQUE (signing_requests_id)
);
